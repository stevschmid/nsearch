...
namespace Alnout {
  ...
  public:
    ...
    void operator<<( const std::pair< Sequence, GlobalSearch::HitList > &queryWithHits ) {
  ...
  private:
    ...
    static AlignmentLines ExtractAlignmentLines( const Sequence &query, const Sequence &target, const Cigar &alignment,
        size_t *outNumCols = NULL, size_t *outNumMatches = NULL, size_t *outNumGaps = NULL )
    {
